...
public:
  ...
  void                receive_first_peer_connected() {
    ...
    priority_queue_insert(&taskScheduler, &delay_download_active(), (cachedTime + rak::timer::from_seconds(2)).round_seconds());
  };
  ...
  void                receive_last_peer_disconnected() {
    ...
    if (!active_queued) {
      priority_queue_insert(&taskScheduler, &delay_download_inactive(), cachedTime);
    }
  }
  ...
  rak::priority_item& delay_download_active()     { return m_delay_download_active; }
  rak::priority_item& delay_download_inactive()   { return m_delay_download_inactive; }
...
private:
  ...
  rak::priority_item  m_delay_download_active;
  rak::priority_item  m_delay_download_inactive;
